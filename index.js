...
const UUID = process.env.UUID || '8e8c0bf7-8476-4694-a3fc-cba16c5308a3'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NAME = process.env.NAME || 'Night';                       // 节点名称
...
const BLOCKED_DOMAINS = [
  'speedtest.cn', 'speed.cloudflare.com'
];
